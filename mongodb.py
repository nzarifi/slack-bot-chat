...
from ChatBot_class_mongo import ChatBot
...
chatbot = ChatBot(
    ...
    mongo_client=mongo_client,  # Add this line
    BOT_ID=BOT_ID  # Assuming you want to pass this as well
)
...
def message(payload):
    ...
    if BOT_ID != user_id:
        #chatbot.load_chat_history(channel_id)
        response = chatbot.chat(text, channel_id)  # Updated to pass channel_id
